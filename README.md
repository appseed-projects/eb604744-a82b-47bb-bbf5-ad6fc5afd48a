...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-02 15:23`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/eb604744-a82b-47bb-bbf5-ad6fc5afd48a.git
$ cd eb604744-a82b-47bb-bbf5-ad6fc5afd48a
```
